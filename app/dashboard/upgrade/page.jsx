    ...
    {PricingPlan.map((item,index)=>(
        ...
        <ul className="mt-6 space-y-2">
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700"> Get access to 3 Free Mock Interviews </span>
          </li>
          ...
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700">Access to Practice Questions </span>
          </li>
          ...
          <li className="flex items-center gap-1">
            ...
            <span className="text-gray-700"> Community center access </span>
          </li>
        </ul>
